...
Some members of the household will be designated as “admins” and will
...
The final “package” of possible functionality that I have considered is
...
I will be aiming to follow TDD/BDD methodologies as much as possible
...
The user should also be able to keep a record of their finances spent at
...
The inventory management section will be used to track the details of
...
Another performance aspect that must be considered is how to optimise
...
On the server, Firebase provide an API to validate and edit the claims
...
Then, in order to scale this down yet again, the web worker process to
...
<img src="media/image2.png" style="width:5.63542in;height:3.80208in" />

<span id="_Ref496568166" class="anchor"><span id="_Toc496570060"
class="anchor"></span></span>Figure 2--Conceptual Module Overview

<img src="media/image3.png" style="width:6in;height:4.02071in" />

<span id="_Ref496569361" class="anchor"><span id="_Toc496570061"
class="anchor"></span></span>Figure 3--Full Physical Implementation

<img src="media/image4.png" style="width:6in;height:4.3567in" />

<span id="_Ref496569451" class="anchor"><span id="_Toc496570062"
class="anchor"></span></span>Figure 4--Mid Physical Implementation

<img src="media/image5.png" style="width:5.15625in;height:6.91731in" />

<span id="_Ref496569952" class="anchor"><span id="_Toc496570063"
class="anchor"></span></span>Figure 5--Small Physical Implementation
